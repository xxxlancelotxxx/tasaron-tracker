...
def dump_sheet(out, name, max_rows=25, max_cols=40):
    ws = wb[name]
...
for s in ["Spent MH", "Budget Code Detailed", "Weekly Personnel", "Progress Summary"]:
    dump_sheet(out, s)

with open(r"C:\Users\berkant.senturk\AppData\Local\Temp\opencode\excel_dump.txt", "w", encoding="utf-8") as f:
    f.write(out.getvalue())
print("Yazildi:", r"C:\Users\berkant.senturk\AppData\Local\Temp\opencode\excel_dump.txt")
print("Boyut:", len(out.getvalue()), "karakter")
